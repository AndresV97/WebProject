<?php 
  session_start();
    ...
    header("Location: ../vista/cosmetiqueras.php");
  }
?>
<!DOCTYPE html>
<html lang="en">
...
?>
 ...
 <!-- Contenedor Imagenes Cosmetiqueras -->
    <div class="container-fluid" id="productos">
      <!-- Primera parte Cosmetiqueras -->
      <div class="row">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/cosm1.jpg" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart42"></div>
              <p class="card-text"><b>$19.000</b></p>
              <p class="card-text">Cosmetiquera Moda Peluche</p>
              <a target="_blank" href="https://tupedidoenlinea.com/product/cosmetiqueras-moda-peluche/" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/cosm2.jpg" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart43"></div>
              <p class="card-text"><b>$85.000</b></p>
              <p class="card-text">Neceser x 3 Rectangular.</p>
              <a target="_blank" href="https://tupedidoenlinea.com/product/neceser-x-3-rectangular/" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/cosm3.jpg" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart44"></div>
              <p class="card-text"><b>$85.000</b></p>
              <p class="card-text">Neceser x 3 Redondo</p>
              <a target="_blank" href="https://tupedidoenlinea.com/product/neceser-x-3-redondo/" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/cosm4.jpg" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart45"></div>
              <p class="card-text"><b>$35.000</b></p>
              <p class="card-text">Mini Canasta Oro Rosa.</p>
              <a target="_blank" href="https://tupedidoenlinea.com/product/mini-canasta-oro-rosa/" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
