<?php 
  session_start();
    ...
    header("Location: ../vista/iluminadores.php");
  }
?>
<!DOCTYPE html>
<html lang="en">
...
<!-- Contenedor Imagenes iliuminadores -->
    <div class="container-fluid" id="productos">
      <!-- Primera parte iluminadores -->
      <div class="row">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/m1.PNG" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart46"></div>
              <p class="card-text"><b>$23.900</b></p>
              <p class="card-text">ILUMINADOR CATRICE ARTIC GLOW.</p>
              <a target="_blank" href="https://www.beautyholics.com/maquillaje-rostro-iluminadores-iluminador-catrice-artic-glow-pb0074805/p" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/m2.PNG" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart47"></div>
              <p class="card-text"><b>$23.900</b></p>
              <p class="card-text">ILUMNADOR CATRICE HIGH GLOW MINERAL HIGHLIGHTING. </p>
              <a target="_blank" href="https://www.beautyholics.com/maquillaje-rostro-iluminadores-ilumnador-catrice-high-glow-mineral-highlighting-tono-030-8g-030-amber-crystal-pb0078512/p" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/m3.PNG" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart48"></div>
              <p class="card-text"><b>$63.500</b></p>
              <p class="card-text">ILUMINADOR MIRACLE GLOW MAX FACTOR.</p>
              <a target="_blank" href="https://www.beautyholics.com/maquillaje-rostro-iluminadores-iluminador-miracle-glow-max-factor-pb0075447/p" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/m4.PNG" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart49"></div>
              <p class="card-text"><b>$8.450</b></p>
              <p class="card-text">ILUMINADOR LIQUIDO INSTA PERFECT TN 20.</p>
              <a target="_blank" href="https://www.beautyholics.com/maquillaje-rostro-iluminadores-iluminador-liquido-insta-perfect-tn-20-pb0075544/p" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
    ...
    <!-- Contenedor Imagenes iluminadores -->
