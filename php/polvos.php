<?php 
  session_start();
    ...
    header("Location: ../vista/polvos.php");
  }
?>
<!DOCTYPE html>
<html lang="en">
...
<!-- Contenedor Imagenes polvos -->
    <div class="container-fluid" id="productos">
      <!-- Primera parte polvos -->
      <div class="row">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/n1.PNG" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart60"></div>
              <p class="card-text"><b>$135.000</b></p>
              <p class="card-text">Polvos Sueltos Peach Perfect Mattifying Setting Powder.</p>
              <a target="_blank" href="https://www.blush-bar.com/peach-perfect-mattifying-setting-powder/p" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/n2.PNG" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart61"></div>
              <p class="card-text"><b>$177.000</b></p>
              <p class="card-text">Polvos Hydra-Mist Set & Refresh Powder. </p>
              <a target="_blank" href="https://www.blush-bar.com/hydra-cool-set-and-refresh-powder/p" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/n3.PNG" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart62"></div>
              <p class="card-text"><b>$190.000</b></p>
              <p class="card-text">Base en Polvo Double Wear Stay-in-place Matte Powder Foundation.</p>
              <a target="_blank" href="https://www.blush-bar.com/base-compacta-double-wear-stay-in-place-matte-powder-foundation/p" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/n4.PNG" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart63"></div>
              <p class="card-text"><b>$110.000</b></p>
              <p class="card-text">Polvos Stay-Matte Sheer Pressed Powder.</p>
              <a target="_blank" href="https://www.blush-bar.com/stay-matte-sheer-pressed-powder-clinique-/p" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
