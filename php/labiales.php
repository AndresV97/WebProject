<?php 
  session_start();
    ...
    header("Location: ../vista/labiales.php");
  }
?>
<!DOCTYPE html>
<html lang="en">
...
?>
 ...
 <!-- Contenedor Imagenes Labiales -->
    <div class="container-fluid" id="productos">
      <!-- Primera parte Labiales -->
      <div class="row">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/lab1.jpeg" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart50"></div>
              <p class="card-text"><b>$7.000</b></p>
              <p class="card-text">Hidratante para Labios Ushas.</p>
              <a target="_blank" href="https://tupedidoenlinea.com/product/hidratante-para-labios-ushas-ref-11481/" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/lab2.jpeg" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart51"></div>
              <p class="card-text"><b>$7.000</b></p>
              <p class="card-text">Labial Magico Ushas Ref. 11460.</p>
              <a target="_blank" href="https://tupedidoenlinea.com/product/labial-magico-ushas-ref-11460/" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/lab3.png" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart52"></div>
              <p class="card-text"><b>$5.000</b></p>
              <p class="card-text">Hidratante de Labios 2 en 1.</p>
              <a target="_blank" href="https://tupedidoenlinea.com/product/hidratante-de-labios-2-en-1-ref-11399/" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/lab4.jpeg" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart53"></div>
              <p class="card-text"><b>$8.000</b></p>
              <p class="card-text">Labial Star Charming Ref.11409.</p>
              <a target="_blank" href="https://tupedidoenlinea.com/product/labial-star-charming-ref-11409/" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>

      </div>
      <!-- Segunda Parte Labiales -->
      <div class="row">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/lab5.jpg" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart54"></div>
              <p class="card-text"><b>$5.000</b></p>
              <p class="card-text">Tintas para Labios.</p>
              <a target="_blank" href="https://tupedidoenlinea.com/product/tintas-para-labios/" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/lab6.jpeg" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart55"></div>
              <p class="card-text"><b>$10.000</b></p>
              <p class="card-text">Exfoliante para Labios Ushas.</p>
              <a target="_blank" href="https://tupedidoenlinea.com/product/exfoliante-para-labios-ushas-ref-11480/" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
      </div>
