<?php 
  session_start();
    ...
    header("Location: ../vista/pestañinas.php");
  }
?>
<!DOCTYPE html>
<html lang="en">
...
<!-- Contenedor Imagenes pestañina -->
    <div class="container-fluid" id="productos">
      <!-- Primera parte pestañina -->
      <div class="row">
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/p1.PNG" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart56"></div>
              <p class="card-text"><b>$8.900</b></p>
              <p class="card-text">PESTAÑINA ESSENCE LASH & BROW LAVABLE.</p>
              <a target="_blank" href="https://www.beautyholics.com/maquillaje-ojos-pestaninas-pestanina-essence-lash-brow-pb0047947/p" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/p2.PNG" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart57"></div>
              <p class="card-text"><b>$27.600</b></p>
              <p class="card-text">PESTAÑINA MAX FACTOR VOLUME MAKER. </p>
              <a target="_blank" href="https://www.beautyholics.com/maquillaje-ojos-pestaninas-max-factor-pestanina-volume-maker-waterproof-pb0069814/p" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/p3.PNG" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart58"></div>
              <p class="card-text"><b>$10.900</b></p>
              <p class="card-text">PESTAÑINA ESSENCE GET BIG LASHES VOLUME BOOST.</p>
              <a target="_blank" href="https://www.beautyholics.com/maquillaje-ojos-pestaninas-pestanina-essence-get-big-lashes-volume-boost-waterproof-pb0047951/p" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="img/p4.PNG" alt="Card image cap" height="220" width="300">
            <div class="card-body"><div class="corazon" id="heart59"></div>
              <p class="card-text"><b>$32.500</b></p>
              <p class="card-text">PESTAÑINA COVERGIRL KATYKAT A PRUEBA DE AGUA NEGRA.</p>
              <a target="_blank" href="https://www.beautyholics.com/maquillaje-ojos-pestaninas-pestanina-covergirl-katykat-a-prueba-de-agua-pb0063006/p" class="btn btn-primary">Ver más</a>
            </div>
          </div>
        </div>
