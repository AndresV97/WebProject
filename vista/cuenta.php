...
<?php 
  session_start();
    ...
    //header("Location: ../php/cuenta.php");
  }
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container-fluid p-5" id="micuenta">
      ...
      <div class="row p-3 mt-4" id="shadow">
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
          <form action="loginv.php" method="POST" name="login" class="formulario">
        ...
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
          <form action="registrov.php" class="formulario" method="POST" name="registro">
